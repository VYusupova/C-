...
#define INTRO_MESSAGE_LEN     10
#define INTRO_MESSAGE "Press ENTER" // приветствие
#define HIDE_INTRO    "           "

#define BOARDS_BEGIN 0            // начало игрового поля левый верхний угол с отступом на 2 позиции
